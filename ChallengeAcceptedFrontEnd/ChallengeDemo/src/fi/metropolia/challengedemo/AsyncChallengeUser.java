/*THIS CLASS ALLOWS A CHALLENGE TO BE SENT TO ANOTHER USER
 * 
 * THE METHOD IS SENT TO THE BACKEND AND INFORMS THE BACKEND WHAT DATA TO EXPECT AND WHAT TO DO WITH IT
 * 
 * IN THIS CASE THE BACKEND EXPECTS A USER ID AND A CHALLENGE ID SO IT CAN ASSIGN IT TO THE CHALLENGES USER
 * 
 * */
...
public class AsyncChallengeUser extends AsyncTask<Integer, Integer, String> {
	...
	public void postData(String valueIWantToSend) {
        ...
        try {
            ...
            nameValuePairs.add(new BasicNameValuePair("method",
                ...
                nameValuePairs.add(new BasicNameValuePair("Challenge", postChallenge));
